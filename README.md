...
Ungrift is a dependency-free Chrome extension that labels posts as you scroll and lets you hide behavioral categories from your **X and LinkedIn feeds**. Settings live in a compact toolbar popover; Ungrift does not display or export the underlying post data.

...
const LINKEDIN_INSTRUCTIONS = Object.freeze([
  "Evaluate this LinkedIn contribution.",
...
const X_INSTRUCTIONS = Object.freeze([
  "Evaluate this X contribution.",
  ...SUBSTANCE_INSTRUCTIONS,
  ...
  "On X, judge empty hot takes, hustle aphorisms, status flexes, rumor hype, and outrage farming as strictly as corporate thought leadership. A plausible sentence is not automatically useful. A claimed insider scoop wrapped in superlatives, inevitability, or competitive drama without a grounded explanation can be grift even if labelled rumor; do not pretend its factual truth was verified.",
  "A personal-experience frame is not an automatic good_intent exemption. Doom monologues that turn a short anecdote into repeated sweeping claims that nobody thinks, everyone is incompetent, humans do nothing, an entire profession is finished, or disaster is inevitable are attention bait when these absolutes dominate. Hours worked, job levels, tenure, and lists of tools do not make those claims grounded. A token reasonable wish or request at the end does not rescue a post dominated by universal alarm. Distinguish this from a scoped workplace complaint that identifies a particular failure, its consequence, and a reason or remedy without escalating to claims about everyone or the whole profession. Anger alone is not grift; the repeated unsupported absolutes are the pattern.",
  "Distinguish a straightforward resignation or career update from a credential-led fear pitch. 'I left a famous lab; I worked at two elite companies; they are gambling with your lives; more below' uses prestige and catastrophe to drive attention without explaining the risk in the supplied post. Judge that pitch as grift rather than granting it the personal-milestone exemption. A substantive warning that explains a failure mechanism, evidence, uncertainty, or a concrete mitigation can be good_intent regardless of whether it argues for or against AI development. Do not assume unseen thread replies supply the missing argument.",
  "Read visible commercial profile cues together with the post. An 'early alpha' or AI-income persona, influencer category, casino/referral link, or paid-channel funnel can clarify the promotional payoff of huge effortless-income claims, recycled 'this is insane/gold' teasers, and bookmark/follow calls. These combinations strongly support grift; an article title or preview promising effortless monthly income is assessable even when the full article is unavailable. Do not label every post by an account grift, infer a hidden business model, or treat crypto/AI interests alone as evidence. Useful material can still pass from a promotional account.",
  "Separate honest humor and ordinary conversation from bait. A short joke, a specific personal anecdote, a concrete complaint, or an explained disagreement need not be educational or professional to be good_intent. Do not use humor as a blanket excuse for humiliation, group stereotypes, or sensational conflict whose only payoff is provoking reactions. Criticism, politics, profanity, and disagreement alone are not grift.",
  "Use supplied quoted or reposted text to interpret brief reactions. Do not infer the contents of unseen images or videos. If the point depends on missing media and the visible framing is not itself assessable bait, choose unclear. Apply these rules in every language."
]);
      ...
      return [
        [`post_${index}_category`, {
          ...
          instructions: [
            ...
            ...(linkedIn ? LINKEDIN_INSTRUCTIONS : X_INSTRUCTIONS),
